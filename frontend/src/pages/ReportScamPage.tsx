      ...
      <div className="mx-auto w-full max-w-[440px] overflow-hidden rounded-[28px] border border-[#dfeaf6] bg-[#f8fbff] text-[#12304a] shadow-[0_28px_65px_rgba(18,48,74,0.12)]">
        <div className="px-5 pt-4 pb-0">
          ...
          <div className="mt-4 flex items-center justify-between">
            <button
              type="button"
              className="grid size-8 place-items-center rounded-full bg-white text-[#12304a] shadow-sm"
              aria-label="Back"
            >
        ...
        <div className="px-5 pb-5 pt-5">
          <div className="rounded-[16px] border border-[#f1c5c5] bg-[#fff1f1] p-4 text-[#b53d46]">
            <div className="flex items-start gap-3">
              ...
              <p className="text-[16px] font-bold leading-6">
                Help us protect the community. Your report will be verified
                using AI trust analysis.
              </p>
            </div>
          </div>
          ...
          <div className="mt-7">
            ...
            <label className="mt-3 block">
              <span className="mb-2 block text-[15px] font-black text-[#12304a]">
                Business Name
              </span>
            ...
            <div className="mt-4 space-y-3">
              {reasonOptions.map((reason, index) => (
                <button
                  ...
                  className={
                    index === 0
                      ? "flex w-full items-center gap-3 rounded-[16px] border border-[#2d6dba] bg-[#edf4ff] p-3 text-left"
                      : "flex w-full items-center gap-3 rounded-[16px] border border-[#dfe8f1] bg-white p-3 text-left shadow-sm"
                  }
                >
                  <div
                    className={
                      index === 0
                        ? "grid size-10 place-items-center rounded-full bg-[#2d6dba] text-white"
                        : "grid size-10 place-items-center rounded-full bg-[#edf2f7] text-[#536a7d]"
                    }
                  >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-[12px] text-[#5d7285]">
                      {reason.description}
                    </div>
                  </div>
                </button>
          ...
          <div className="mt-7">
            ...
            <label className="mt-3 block">
              ...
              />
              <div className="mt-2 text-right text-[12px] font-semibold text-[#7b8fa0]">
                Min. 20 characters
              </div>
            </label>
          </div>
          ...
          <div className="mt-7">
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="inline-flex rounded-full border border-[#dfe8f1] bg-white px-3 py-1 text-[11px] font-black uppercase tracking-[0.12em] text-[#5d7285]">
                Optional
              </span>
            </div>
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="grid place-items-center rounded-[14px] border border-dashed border-[#dfe8f1] bg-[#f7f9fb] px-4 py-5 text-center">
                ...
                <div className="text-[16px] font-bold text-[#4c6479]">
                  Upload
                </div>
              </div>
              <div className="relative grid place-items-center rounded-[14px] border border-[#dfe8f1] bg-[radial-gradient(circle_at_15%_15%,#3d3d3d,#141414)] p-4 text-white">
                <div className="absolute right-2 top-2 grid size-6 place-items-center rounded-full bg-[#ff5a5a] text-[10px] font-black text-white">
                  ×
                </div>
            ...
            <p className="mt-4 text-[14px] leading-6 text-[#5d7285]">
              Upload screenshots of chats, receipts, or misleading
              advertisements.
            </p>
          </div>
          ...
          <label className="mt-7 flex items-center gap-3 rounded-[16px] border border-[#dfe8f1] bg-white p-3 text-[14px] text-[#49637a] shadow-sm">
            ...
            <span className="flex-1">
              ...
              <span className="block text-[#678097]">
                Our investigators may contact you if they need more information
          ...
          <button
            type="button"
            className="mt-7 w-full rounded-[18px] bg-gradient-to-r from-[#12304a] via-[#1b4068] to-[#2f68f1] px-5 py-4 text-[28px] font-black text-white shadow-[0_18px_30px_rgba(47,104,241,0.25)] transition hover:-translate-y-0.5"
          >
            Submit Report
          </button>
          ...
          <p className="mt-4 text-center text-[12px] leading-6 text-[#627b91]">
            ...
            to the best of your knowledge. False reporting may lead to account
            suspension.
          </p>
        </div>
